...
var CompilerFragment = {
    ...
    getInputsFromShadow: function ( shadowReceive, shadowTexture, lighted, lightNum ) {
        ...
        var inputs = {
            ...
            shadowTextureRenderSize: this.getOrCreateUniform( textureUniforms[ 'RenderSize' + suffix ] ),
            shadowTextureProjectionMatrix: this.getOrCreateUniform( textureUniforms[ 'ProjectionMatrix' + suffix ] ),
            shadowTextureViewMatrix: this.getOrCreateUniform( textureUniforms[ 'ViewMatrix' + suffix ] ),
            shadowTextureDepthRange: this.getOrCreateUniform( textureUniforms[ 'DepthRange' + suffix ] ),
        ...
        if ( shadowReceive.getAtlas() ) inputs.shadowTextureMapSize = this.getOrCreateUniform( textureUniforms[ 'MapSize' + suffix ] );
